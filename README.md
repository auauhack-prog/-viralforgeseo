...
[GitHub](https://github.com/auauhack-prog/viralforge) | [演示](https://skill.600.im) | [联系](https://skill.600.im)
...
### Codex
```
codex skill add auauhack-prog/viralforge
```

### Claude Code
```
npx skills add auauhack-prog/viralforge
```

### 手动安装
```bash
git clone https://github.com/auauhack-prog/viralforge.git
cd viralforge
...
| 平台 | 安装方式 | 适用场景 | 状态 |
|------|----------|----------|------|
| Codex CLI | `codex skill add auauhack-prog/viralforge` | 命令行批量处理 | 已上线 |
| Claude Code | `npx skills add auauhack-prog/viralforge` | AI 编程助手集成 | 已上线 |
